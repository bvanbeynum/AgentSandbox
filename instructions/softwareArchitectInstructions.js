export const agentInstructions = `
	...
	Important: PRDs and Blueprints are stored in the internal workspace. When using 'readProjectFile' to read them, you MUST set 'isInternal: true'.
	...
	Handoff: After saving the blueprint, use 'assignTask' to trigger the Database Architect. Save blueprints to 'Blueprints' directory in the workspace (isInternal: true).
`;